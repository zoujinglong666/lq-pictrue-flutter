                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color:
                                      const Color(0xFF8A9BAE).withOpacity(0.12),
                          ...
                          child: LayoutBuilder(
                            builder: (context, constraints) {
                              ...
                              final availableHeight = screenHeight -
                                  keyboardHeight -
                                  250; // 减去顶部元素高度
                              final maxPanelHeight = (availableHeight * 0.6)
                                  .clamp(200.0, 500.0); // 限制范围
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        // 图片容器
                                        AspectRatio(
                                          // 限制宽高比范围：0.5(1:2) ~ 2(2:1)，避免图片过长或过宽
                                          aspectRatio: _calculateAspectRatio(
                                            image.picWidth.toDouble(),
                                            image.picHeight.toDouble(),
                                          ),
                                          child: Stack(
                                            children: [
                                              Container(
